...
('def_ammo_large_railgun_a_pr',1,133120,196874,'#damageChemical=f0.00  #damageKinetic=f32.00  #damageExplosive=f0.00  #damageThermal=f16.00  #optimalRangeModifier=f1.00  #explosion_radius=f0  #bullettime=f53.0  #tier=$tierlevel_pr','',2,0.4,'def_ammo_railgun_a_desc',2,NULL),
('def_ammo_large_railgun_b_pr',1,133120,196874,'#damageChemical=f0.00  #damageKinetic=f56.00  #damageExplosive=f0.00  #damageThermal=f0.00  #optimalRangeModifier=f0.75  #explosion_radius=f0  #bullettime=f53.0  #tier=$tierlevel_pr','',2,0.4,'def_ammo_railgun_b_desc',2,NULL),
('def_ammo_large_railgun_c_pr',1,133120,196874,'#damageChemical=f0.00  #damageKinetic=f32.00  #damageExplosive=f24.00  #damageThermal=f16.00  #optimalRangeModifier=f0.50  #explosion_radius=f0  #bullettime=f53.0  #tier=$tierlevel_pr','',2,0.4,'def_ammo_railgun_c_desc',2,NULL),
('def_ammo_large_railgun_d_pr',1,133120,196874,'#damageChemical=f32.00  #damageKinetic=f24.00  #damageExplosive=f0.00  #damageThermal=f0.00  #optimalRangeModifier=f0.75  #explosion_radius=f0  #bullettime=f53.0  #tier=$tierlevel_pr','',2,0.4,'def_ammo_railgun_d_desc',2,NULL),
('def_ammo_large_lasercrystal_a_pr',1,133120,197130,'#damageChemical=f0.00  #damageKinetic=f0.00  #damageExplosive=f0.00  #damageThermal=f48.00  #optimalRangeModifier=f1.00  #explosion_radius=f0  #bullettime=f3000.0  #tier=$tierlevel_pr','',2,0.4,'def_ammo_lasercrystal_a_desc',2,NULL),
('def_ammo_large_lasercrystal_b_pr',1,133120,197130,'#damageChemical=f0.00  #damageKinetic=f0.00  #damageExplosive=f8.00  #damageThermal=f48.00  #optimalRangeModifier=f0.75  #explosion_radius=f0  #bullettime=f3000.0  #tier=$tierlevel_pr','',2,0.4,'def_ammo_lasercrystal_b_desc',2,NULL),
('def_ammo_large_lasercrystal_c_pr',1,133120,197130,'#damageChemical=f0.00  #damageKinetic=f16.00  #damageExplosive=f16.00  #damageThermal=f40.00  #optimalRangeModifier=f0.50  #explosion_radius=f0  #bullettime=f3000.0  #tier=$tierlevel_pr','',2,0.4,'def_ammo_lasercrystal_c_desc',2,NULL),
('def_ammo_large_lasercrystal_d_pr',1,133120,197130,'#damageChemical=f28.00  #damageKinetic=f0.00  #damageExplosive=f0.00  #damageThermal=f28.00  #optimalRangeModifier=f0.75  #explosion_radius=f0  #bullettime=f3000.0  #tier=$tierlevel_pr','',2,0.4,'def_ammo_lasercrystal_d_desc',2,NULL),
('def_ammo_cruisemissile_a_pr',1,133120,197642,'#damageChemical=f0.00  #damageKinetic=f90.00  #damageExplosive=f90.00  #damageThermal=f0.00  #range=f40  #explosion_radius=f16  #bullettime=f7.0  #tier=$tierlevel_pr','',2,0.75,'def_ammo_cruisemissile_a_desc',2,NULL),
('def_ammo_cruisemissile_b_pr',1,133120,197642,'#damageChemical=f0.00  #damageKinetic=f0.00  #damageExplosive=f180.00  #damageThermal=f0.00  #range=f40  #explosion_radius=f12  #bullettime=f7.0  #tier=$tierlevel_pr','',2,0.75,'def_ammo_cruisemissile_b_desc',2,NULL),
('def_ammo_cruisemissile_c_pr',1,133120,197642,'#damageChemical=f0.00  #damageKinetic=f0.00  #damageExplosive=f90.00  #damageThermal=f90.00  #range=f40  #explosion_radius=f16  #bullettime=f7.0  #tier=$tierlevel_pr','',2,0.75,'def_ammo_cruisemissile_c_desc',2,NULL),
('def_ammo_cruisemissile_d_pr',1,133120,197642,'#damageChemical=f90.00  #damageKinetic=f0.00  #damageExplosive=f90.00  #damageThermal=f0.00  #range=f40  #explosion_radius=f16  #bullettime=f7.0  #tier=$tierlevel_pr','',2,0.75,'def_ammo_cruisemissile_d_desc',2,NULL),
('def_ammo_longrange_cruisemissile_a_pr',1,133120,197642,'#damageChemical=f0.00  #damageKinetic=f90.00  #damageExplosive=f90.00  #damageThermal=f0.00  #range=f40  #explosion_radius=f16  #bullettime=f7.0  #tier=$tierlevel_pr','',2,0.75,'def_ammo_longrange_cruisemissile_a_desc',2,NULL),
('def_ammo_longrange_cruisemissile_b_pr',1,133120,197642,'#damageChemical=f0.00  #damageKinetic=f0.00  #damageExplosive=f180.00  #damageThermal=f0.00  #range=f40  #explosion_radius=f12  #bullettime=f7.0  #tier=$tierlevel_pr','',2,0.75,'def_ammo_longrange_cruisemissile_b_desc',2,NULL),
('def_ammo_longrange_cruisemissile_c_pr',1,133120,197642,'#damageChemical=f0.00  #damageKinetic=f0.00  #damageExplosive=f90.00  #damageThermal=f90.00  #range=f40  #explosion_radius=f16  #bullettime=f7.0  #tier=$tierlevel_pr','',2,0.75,'def_ammo_longrange_cruisemissile_c_desc',2,NULL),
('def_ammo_longrange_cruisemissile_d_pr',1,133120,197642,'#damageChemical=f90.00  #damageKinetic=f0.00  #damageExplosive=f90.00  #damageThermal=f0.00  #range=f40  #explosion_radius=f16  #bullettime=f7.0  #tier=$tierlevel_pr','',2,0.75,'def_ammo_longrange_cruisemissile_d_desc',2,NULL);
