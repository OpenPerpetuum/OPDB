...
VALUES
		   ...
		   (@commonPlasma,2925,3575,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_beta2'),1),
		   	-- Frags Common
           (@commonBasicFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_alpha1'),1),
		   (@commonAdvFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_alpha1'),1),
		   (@commonExpFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_alpha1'),1),

           (@commonBasicFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_alpha1'),1),
		   (@commonAdvFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_alpha1'),1),
		   (@commonExpFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_alpha1'),1),

		   (@commonBasicFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_alpha1'),1),
		   (@commonAdvFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_alpha1'),1),
		   (@commonExpFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_alpha1'),1),

		   (@commonBasicFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_alpha2'),1),
		   (@commonAdvFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_alpha2'),1),
		   (@commonExpFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_alpha2'),1),

		   (@commonBasicFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_alpha2'),1),
		   (@commonAdvFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_alpha2'),1),
		   (@commonExpFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_alpha2'),1),

		   (@commonBasicFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_alpha2'),1),
		   (@commonAdvFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_alpha2'),1),
		   (@commonExpFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_alpha2'),1),

		   (@commonBasicFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_beta1'),1),
		   (@commonAdvFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_beta1'),1),
		   (@commonExpFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_beta1'),1),

		   (@commonBasicFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_beta1'),1),
		   (@commonAdvFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_beta1'),1),
		   (@commonExpFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_beta1'),1),

		   (@commonBasicFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_beta1'),1),
		   (@commonAdvFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_beta1'),1),
		   (@commonExpFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_beta1'),1),

		   (@commonBasicFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_beta2'),1),
		   (@commonAdvFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_beta2'),1),
		   (@commonExpFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_indy_beta2'),1),

		   (@commonBasicFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_beta2'),1),
		   (@commonAdvFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_beta2'),1),
		   (@commonExpFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_indy_beta2'),1),

		   (@commonBasicFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_beta2'),1),
		   (@commonAdvFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_beta2'),1),
		   (@commonExpFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_indy_beta2'),1),
		   ...
		   (@numiqolPlasma,2925,3575,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_beta2'),1),
		   		   	-- Frags Common
           (@nuimqolBasicFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_alpha1'),1),
		   (@nuimqolAdvFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_alpha1'),1),
		   (@nuimqolExpFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_alpha1'),1),

           (@nuimqolBasicFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_alpha1'),1),
		   (@nuimqolAdvFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_alpha1'),1),
		   (@nuimqolExpFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_alpha1'),1),

		   (@nuimqolBasicFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_alpha1'),1),
		   (@nuimqolAdvFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_alpha1'),1),
		   (@nuimqolExpFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_alpha1'),1),

		   (@nuimqolBasicFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_alpha2'),1),
		   (@nuimqolAdvFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_alpha2'),1),
		   (@nuimqolExpFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_alpha2'),1),

		   (@nuimqolBasicFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_alpha2'),1),
		   (@nuimqolAdvFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_alpha2'),1),
		   (@nuimqolExpFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_alpha2'),1),

		   (@nuimqolBasicFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_alpha2'),1),
		   (@nuimqolAdvFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_alpha2'),1),
		   (@nuimqolExpFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_alpha2'),1),

		   (@nuimqolBasicFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_beta1'),1),
		   (@nuimqolAdvFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_beta1'),1),
		   (@nuimqolExpFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_beta1'),1),

		   (@nuimqolBasicFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_beta1'),1),
		   (@nuimqolAdvFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_beta1'),1),
		   (@nuimqolExpFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_beta1'),1),

		   (@nuimqolBasicFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_beta1'),1),
		   (@nuimqolAdvFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_beta1'),1),
		   (@nuimqolExpFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_beta1'),1),

		   (@nuimqolBasicFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_beta2'),1),
		   (@nuimqolAdvFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_beta2'),1),
		   (@nuimqolExpFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_numiqol_beta2'),1),

		   (@nuimqolBasicFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_beta2'),1),
		   (@nuimqolAdvFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_beta2'),1),
		   (@nuimqolExpFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_numiqol_beta2'),1),

		   (@nuimqolBasicFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_beta2'),1),
		   (@nuimqolAdvFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_beta2'),1),
		   (@nuimqolExpFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_numiqol_beta2'),1),
		   ...
		   (@thelodicaPlasma,2925,3575,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_beta2'),1),
		   		   	-- Frags Common
           (@thelodicaBasicFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_alpha1'),1),
		   (@thelodicaAdvFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_alpha1'),1),
		   (@thelodicaExpFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_alpha1'),1),

           (@thelodicaBasicFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_alpha1'),1),
		   (@thelodicaAdvFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_alpha1'),1),
		   (@thelodicaExpFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_alpha1'),1),

		   (@thelodicaBasicFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_alpha1'),1),
		   (@thelodicaAdvFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_alpha1'),1),
		   (@thelodicaExpFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_alpha1'),1),

		   (@thelodicaBasicFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_alpha2'),1),
		   (@thelodicaAdvFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_alpha2'),1),
		   (@thelodicaExpFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_alpha2'),1),

		   (@thelodicaBasicFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_alpha2'),1),
		   (@thelodicaAdvFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_alpha2'),1),
		   (@thelodicaExpFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_alpha2'),1),

		   (@thelodicaBasicFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_alpha2'),1),
		   (@thelodicaAdvFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_alpha2'),1),
		   (@thelodicaExpFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_alpha2'),1),

		   (@thelodicaBasicFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_beta1'),1),
		   (@thelodicaAdvFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_beta1'),1),
		   (@thelodicaExpFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_beta1'),1),

		   (@thelodicaBasicFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_beta1'),1),
		   (@thelodicaAdvFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_beta1'),1),
		   (@thelodicaExpFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_beta1'),1),

		   (@thelodicaBasicFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_beta1'),1),
		   (@thelodicaAdvFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_beta1'),1),
		   (@thelodicaExpFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_beta1'),1),

		   (@thelodicaBasicFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_beta2'),1),
		   (@thelodicaAdvFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_beta2'),1),
		   (@thelodicaExpFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_thelodica_beta2'),1),

		   (@thelodicaBasicFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_beta2'),1),
		   (@thelodicaAdvFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_beta2'),1),
		   (@thelodicaExpFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_thelodica_beta2'),1),

		   (@thelodicaBasicFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_beta2'),1),
		   (@thelodicaAdvFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_beta2'),1),
		   (@thelodicaExpFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_thelodica_beta2'),1),
		   ...
		   (@pelistalPlasma,2925,3575,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_beta2'),1),
		   	-- Frags pelistal
           (@pelistalBasicFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_alpha1'),1),
		   (@pelistalAdvFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_alpha1'),1),
		   (@pelistalExpFrag,10,15,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_alpha1'),1),

           (@pelistalBasicFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_alpha1'),1),
		   (@pelistalAdvFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_alpha1'),1),
		   (@pelistalExpFrag,15,20,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_alpha1'),1),

		   (@pelistalBasicFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_alpha1'),1),
		   (@pelistalAdvFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_alpha1'),1),
		   (@pelistalExpFrag,20,25,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_alpha1'),1),

		   (@pelistalBasicFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_alpha2'),1),
		   (@pelistalAdvFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_alpha2'),1),
		   (@pelistalExpFrag,25,30,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_alpha2'),1),

		   (@pelistalBasicFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_alpha2'),1),
		   (@pelistalAdvFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_alpha2'),1),
		   (@pelistalExpFrag,30,35,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_alpha2'),1),

		   (@pelistalBasicFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_alpha2'),1),
		   (@pelistalAdvFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_alpha2'),1),
		   (@pelistalExpFrag,35,40,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_alpha2'),1),

		   (@pelistalBasicFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_beta1'),1),
		   (@pelistalAdvFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_beta1'),1),
		   (@pelistalExpFrag,40,45,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_beta1'),1),

		   (@pelistalBasicFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_beta1'),1),
		   (@pelistalAdvFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_beta1'),1),
		   (@pelistalExpFrag,45,50,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_beta1'),1),

		   (@pelistalBasicFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_beta1'),1),
		   (@pelistalAdvFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_beta1'),1),
		   (@pelistalExpFrag,50,55,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_beta1'),1),

		   (@pelistalBasicFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_beta2'),1),
		   (@pelistalAdvFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_beta2'),1),
		   (@pelistalExpFrag,55,60,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level1_pelistal_beta2'),1),

		   (@pelistalBasicFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_beta2'),1),
		   (@pelistalAdvFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_beta2'),1),
		   (@pelistalExpFrag,60,65,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level2_pelistal_beta2'),1),

		   (@pelistalBasicFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_beta2'),1),
		   (@pelistalAdvFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_beta2'),1),
		   (@pelistalExpFrag,65,70,1.0,(SELECT relicinfos.id FROM relicinfos WHERE name='relic_level3_pelistal_beta2'),1);
GO
