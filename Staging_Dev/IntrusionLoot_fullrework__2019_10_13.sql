...
--SPECI
--0-49
	(@nuimqolOutpost, @speciSAP, @cortexLight, 1, 1, 0, 49, 0.5),
	(@nuimqolOutpost, @speciSAP, @cortexAssault, 1, 1, 0, 49, 0.25),
	(@nuimqolOutpost, @speciSAP, @cortexMech, 1, 1, 0, 49, 0.15),
	(@nuimqolOutpost, @speciSAP, @cortexHMech, 1, 1, 0, 49, 0.1),
	(@nuimqolOutpost, @speciSAP, @kernelCommon, 900, 1100, 0, 49, 1),
	(@nuimqolOutpost, @speciSAP, @kernelNuimqol, 900, 1100, 0, 49, 1),
	(@nuimqolOutpost, @speciSAP, @kernelHitech, 150, 250, 0, 49, 1),

	(@pelistalOutpost, @speciSAP, @cortexLight, 1, 1, 0, 49, 0.5),
	(@pelistalOutpost, @speciSAP, @cortexAssault, 1, 1, 0, 49, 0.25),
	(@pelistalOutpost, @speciSAP, @cortexMech, 1, 1, 0, 49, 0.15),
	(@pelistalOutpost, @speciSAP, @cortexHMech, 1, 1, 0, 49, 0.1),
	(@pelistalOutpost, @speciSAP, @kernelCommon, 900, 1100, 0, 49, 1),
	(@pelistalOutpost, @speciSAP, @kernelPelistal, 900, 1100, 0, 49, 1),
	(@pelistalOutpost, @speciSAP, @kernelHitech, 150, 250, 0, 49, 1),

	(@thelodicaOutpost, @speciSAP, @cortexLight, 1, 1, 0, 49, 0.5),
	(@thelodicaOutpost, @speciSAP, @cortexAssault, 1, 1, 0, 49, 0.25),
	(@thelodicaOutpost, @speciSAP, @cortexMech, 1, 1, 0, 49, 0.15),
	(@thelodicaOutpost, @speciSAP, @cortexHMech, 1, 1, 0, 49, 0.1),
	(@thelodicaOutpost, @speciSAP, @kernelCommon, 900, 1100, 0, 49, 1),
	(@thelodicaOutpost, @speciSAP, @kernelThelodica, 900, 1100, 0, 49, 1),
	(@thelodicaOutpost, @speciSAP, @kernelHitech, 150, 250, 0, 49, 1),
--50-99
	(@nuimqolOutpost, @speciSAP, @cortexLight, 1, 2, 50, 99, 0.5),
	(@nuimqolOutpost, @speciSAP, @cortexAssault, 1, 2, 50, 99, 0.25),
	(@nuimqolOutpost, @speciSAP, @cortexMech, 1, 2, 50, 99, 0.15),
	(@nuimqolOutpost, @speciSAP, @cortexHMech, 1, 2, 50, 99, 0.1),
	...
	(@pelistalOutpost, @speciSAP, @cortexLight, 1, 2, 50, 99, 0.5),
	(@pelistalOutpost, @speciSAP, @cortexAssault, 1, 2, 50, 99, 0.25),
	(@pelistalOutpost, @speciSAP, @cortexMech, 1, 2, 50, 99, 0.15),
	(@pelistalOutpost, @speciSAP, @cortexHMech, 1, 2, 50, 99, 0.1),
	...
	(@thelodicaOutpost, @speciSAP, @cortexLight, 1, 2, 50, 99, 0.5),
	(@thelodicaOutpost, @speciSAP, @cortexAssault, 1, 2, 50, 99, 0.25),
	(@thelodicaOutpost, @speciSAP, @cortexMech, 1, 2, 50, 99, 0.15),
	(@thelodicaOutpost, @speciSAP, @cortexHMech, 1, 2, 50, 99, 0.1),
...
--100+
	(@nuimqolOutpost, @speciSAP, @cortexLight, 1, 3, 100, 200, 0.5),
	(@nuimqolOutpost, @speciSAP, @cortexAssault, 1, 3, 100, 200, 0.25),
	(@nuimqolOutpost, @speciSAP, @cortexMech, 1, 3, 100, 200, 0.15),
	(@nuimqolOutpost, @speciSAP, @cortexHMech, 1, 3, 100, 200, 0.1),
	...
	(@pelistalOutpost, @speciSAP, @cortexLight, 1, 3, 100, 200, 0.5),
	(@pelistalOutpost, @speciSAP, @cortexAssault, 1, 3, 100, 200, 0.25),
	(@pelistalOutpost, @speciSAP, @cortexMech, 1, 3, 100, 200, 0.15),
	(@pelistalOutpost, @speciSAP, @cortexHMech, 1, 3, 100, 200, 0.1),
	...
	(@thelodicaOutpost, @speciSAP, @cortexLight, 1, 3, 100, 200, 0.5),
	(@thelodicaOutpost, @speciSAP, @cortexAssault, 1, 3, 100, 200, 0.25),
	(@thelodicaOutpost, @speciSAP, @cortexMech, 1, 3, 100, 200, 0.15),
	(@thelodicaOutpost, @speciSAP, @cortexHMech, 1, 3, 100, 200, 0.1),
