...
DECLARE @turretResist AS INT = 150;
DECLARE @turretResistPeak AS INT = 200;
DECLARE @turretLockRangeMod AS FLOAT = 1.1;
DECLARE @turretFalloffMod AS FLOAT = 2.0;
DECLARE @turretOptimalMod AS FLOAT = 0.9;
DECLARE @turretDamageMod AS FLOAT = 0.5;
DECLARE @turretRepAmountMod AS FLOAT = 2.0;
...
--NPC defs
(6094,'def_npc_pbs_turret_laser_rank0', 1024, 911, 0, 0, NULL, @npcDesc),
(6095,'def_npc_pbs_turret_em_rank0', 1024, 911, 0, 0, NULL, @npcDesc),
(6096,'def_npc_pbs_turret_missile_rank0', 1024, 911, 0, 0, NULL, @npcDesc),
(6097,'def_npc_pbs_turret_ew_rank0', 1024, 911, 0, 0, NULL, @npcDesc);
...
('def_npc_pbs_turret_laser_rank0', 'def_npc_pbs_turret_laser_template', 10),
('def_npc_pbs_turret_em_rank0', 'def_npc_pbs_turret_em_temlate', 10),
('def_npc_pbs_turret_missile_rank0', 'def_npc_pbs_turret_missile_template', 10),
('def_npc_pbs_turret_ew_rank0', 'def_npc_pbs_turret_ew_template', 10);
...
('def_npc_pbs_turret_laser_rank0', 'armor_max_modifier', 1.05),
('def_npc_pbs_turret_laser_rank0', 'armor_repair_amount_modifier', @turretRepAmountMod),
('def_npc_pbs_turret_laser_rank0', 'armor_repair_cycle_time_modifier', @turretRepRateMod),
('def_npc_pbs_turret_laser_rank0', 'core_max_modifier',2),
('def_npc_pbs_turret_laser_rank0', 'core_recharge_time_modifier',0.5),
('def_npc_pbs_turret_laser_rank0', 'damage_modifier', @turretDamageMod),
('def_npc_pbs_turret_laser_rank0', 'falloff_modifier', @turretFalloffMod),
('def_npc_pbs_turret_laser_rank0', 'locking_range_modifier', @turretLockRangeMod),
('def_npc_pbs_turret_laser_rank0', 'locking_time_modifier', 1.25),
('def_npc_pbs_turret_laser_rank0', 'missile_cycle_time_modifier', 1.1),
('def_npc_pbs_turret_laser_rank0', 'optimal_range_modifier', @turretOptimalMod),
('def_npc_pbs_turret_laser_rank0', 'turret_fallof_modifier', @turretFalloffMod),
('def_npc_pbs_turret_laser_rank0', 'resist_chemical', @turretResist),
('def_npc_pbs_turret_laser_rank0', 'resist_explosive', @turretResist),
('def_npc_pbs_turret_laser_rank0', 'resist_kinetic', @turretResist),
('def_npc_pbs_turret_laser_rank0', 'resist_thermal', @turretResistPeak),
('def_npc_pbs_turret_laser_rank0', 'turret_cycle_time_modifier', 1.1),
('def_npc_pbs_turret_laser_rank0', 'received_repaired_modifier', 1.1),
--
('def_npc_pbs_turret_em_rank0', 'armor_max_modifier', 1.05),
('def_npc_pbs_turret_em_rank0', 'armor_repair_amount_modifier', @turretRepAmountMod),
('def_npc_pbs_turret_em_rank0', 'armor_repair_cycle_time_modifier', @turretRepRateMod),
('def_npc_pbs_turret_em_rank0', 'core_max_modifier',2),
('def_npc_pbs_turret_em_rank0', 'core_recharge_time_modifier',0.5),
('def_npc_pbs_turret_em_rank0', 'damage_modifier', @turretDamageMod),
('def_npc_pbs_turret_em_rank0', 'falloff_modifier', @turretFalloffMod),
('def_npc_pbs_turret_em_rank0', 'locking_range_modifier', @turretLockRangeMod),
('def_npc_pbs_turret_em_rank0', 'locking_time_modifier', 1.25),
('def_npc_pbs_turret_em_rank0', 'missile_cycle_time_modifier', 1.1),
('def_npc_pbs_turret_em_rank0', 'optimal_range_modifier', @turretOptimalMod),
('def_npc_pbs_turret_em_rank0', 'turret_fallof_modifier', @turretFalloffMod),
('def_npc_pbs_turret_em_rank0', 'resist_chemical', @turretResist),
('def_npc_pbs_turret_em_rank0', 'resist_explosive', @turretResist),
('def_npc_pbs_turret_em_rank0', 'resist_kinetic', @turretResistPeak),
('def_npc_pbs_turret_em_rank0', 'resist_thermal', @turretResist),
('def_npc_pbs_turret_em_rank0', 'turret_cycle_time_modifier', 1.1),
('def_npc_pbs_turret_em_rank0', 'received_repaired_modifier', 1.1),
--
('def_npc_pbs_turret_missile_rank0', 'armor_max_modifier', 1.05),
('def_npc_pbs_turret_missile_rank0', 'armor_repair_amount_modifier', @turretRepAmountMod),
('def_npc_pbs_turret_missile_rank0', 'armor_repair_cycle_time_modifier', @turretRepRateMod),
('def_npc_pbs_turret_missile_rank0', 'core_max_modifier',2),
('def_npc_pbs_turret_missile_rank0', 'core_recharge_time_modifier',0.5),
('def_npc_pbs_turret_missile_rank0', 'damage_modifier', @turretDamageMod),
('def_npc_pbs_turret_missile_rank0', 'falloff_modifier', @turretFalloffMod),
('def_npc_pbs_turret_missile_rank0', 'locking_range_modifier', @turretLockRangeMod),
('def_npc_pbs_turret_missile_rank0', 'locking_time_modifier', 1.25),
('def_npc_pbs_turret_missile_rank0', 'missile_cycle_time_modifier', 1.1),
('def_npc_pbs_turret_missile_rank0', 'effect_missile_range_modifier', 1.1),
('def_npc_pbs_turret_missile_rank0', 'optimal_range_modifier', @turretOptimalMod),
('def_npc_pbs_turret_missile_rank0', 'missile_falloff_modifier', @turretFalloffMod),
('def_npc_pbs_turret_missile_rank0', 'resist_chemical', @turretResist),
('def_npc_pbs_turret_missile_rank0', 'resist_explosive', @turretResistPeak),
('def_npc_pbs_turret_missile_rank0', 'resist_kinetic', @turretResist),
('def_npc_pbs_turret_missile_rank0', 'resist_thermal', @turretResist),
('def_npc_pbs_turret_missile_rank0', 'turret_cycle_time_modifier', 1.1),
('def_npc_pbs_turret_missile_rank0', 'received_repaired_modifier', 1.1),
--
('def_npc_pbs_turret_ew_rank0', 'armor_max_modifier', 1.05),
('def_npc_pbs_turret_ew_rank0', 'armor_repair_amount_modifier', @turretRepAmountMod),
('def_npc_pbs_turret_ew_rank0', 'armor_repair_cycle_time_modifier', @turretRepRateMod),
('def_npc_pbs_turret_ew_rank0', 'core_max_modifier',2),
('def_npc_pbs_turret_ew_rank0', 'core_recharge_time_modifier',0.5),
('def_npc_pbs_turret_ew_rank0', 'damage_modifier', @turretDamageMod),
('def_npc_pbs_turret_ew_rank0', 'ecm_strength_modifier', @turretDamageMod),
('def_npc_pbs_turret_ew_rank0', 'energy_neutralized_amount_modifier', @turretDamageMod),
('def_npc_pbs_turret_ew_rank0', 'falloff_modifier', @turretFalloffMod),
('def_npc_pbs_turret_ew_rank0', 'locking_range_modifier', @turretLockRangeMod),
('def_npc_pbs_turret_ew_rank0', 'locking_time_modifier', 1.25),
('def_npc_pbs_turret_ew_rank0', 'missile_cycle_time_modifier', 1.1),
('def_npc_pbs_turret_ew_rank0', 'optimal_range_modifier', @turretOptimalMod),
('def_npc_pbs_turret_ew_rank0', 'resist_chemical', @turretResist),
('def_npc_pbs_turret_ew_rank0', 'resist_explosive', @turretResist),
('def_npc_pbs_turret_ew_rank0', 'resist_kinetic', @turretResist),
('def_npc_pbs_turret_ew_rank0', 'resist_thermal', @turretResist),
('def_npc_pbs_turret_ew_rank0', 'turret_cycle_time_modifier', 1.1),
('def_npc_pbs_turret_ew_rank0', 'received_repaired_modifier', 1.1);
...
('level2_ew','def_npc_pbs_turret_ew_rank0', 1, 2, 1.0),
...
('level3_em','def_npc_pbs_turret_em_rank0', 1, 3, 0.33),
('level3_missile','def_npc_pbs_turret_missile_rank0', 1, 3, 0.33),
('level3_laser','def_npc_pbs_turret_laser_rank0', 1, 3, 0.33),
('level3_ew','def_npc_pbs_e_emitter_rank1', 1, 3, 1.0),

('level4_em','def_npc_pbs_turret_em_rank0', 1, 4, 0.5),
('level4_missile','def_npc_pbs_turret_missile_rank0', 1, 4, 0.5),
('level4_laser','def_npc_pbs_turret_laser_rank0', 1, 4, 0.5),
...
('level5_em','def_npc_pbs_turret_em_rank0', 1, 5, 0.66),
('level5_missile','def_npc_pbs_turret_missile_rank0', 1, 5, 0.66),
('level5_laser','def_npc_pbs_turret_laser_rank0', 1, 5, 0.66),
('level5_boost','def_npc_pbs_eff_booster_rank1', 1, 5, 1.0),

('level6_em','def_npc_pbs_turret_em_rank0', 1, 6, 0.99),
('level6_missile','def_npc_pbs_turret_missile_rank0', 1, 6, 0.99),
('level6_laser','def_npc_pbs_turret_laser_rank0', 1, 6, 0.99),
('level6_ew','def_npc_pbs_turret_ew_rank0', 1, 6, 1.0),
